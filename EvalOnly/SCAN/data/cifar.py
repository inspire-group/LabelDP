...
class CIFAR10(Dataset):
    ...
    def __init__(self, root=MyPath.db_root_dir('cifar10'), train=True, transform=None, 
                    download=False):
...
class CIFAR100(CIFAR10):
    ...
    def __init__(self, root=MyPath.db_root_dir('cifar100'), train=True, transform=None, 
                    download=False):
...
class CIFAR20(CIFAR10):
    ...
    def __init__(self, root=MyPath.db_root_dir('cifar20'), train=True, transform=None, 
                    download=False):
