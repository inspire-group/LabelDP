...
def create_config(config_file_exp):
    ...
    root_dir = os.path.join(MyPath.ckpt_root_dir(), 'SCAN')
    ...
    if cfg['backbone'] == 'wideresnet284':
        cfg['batch_size'] = 128
        cfg['model_kwargs']['features_dim'] = 256
    base_dir = os.path.join(root_dir, cfg['train_db_name'], cfg['backbone'])
